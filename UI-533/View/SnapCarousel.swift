...
struct SnapCarousel<Content : View,T : Identifiable>: View {
        ...
        GeometryReader{proxy in
            ...
            .gesture(
                ...
                DragGesture().updating($offset, body: { value, out, _ in
                    ...
                    out = (value.translation.width / 1.5)//just move
                })
                    .onEnded({ value in
    ...
    func getOffset(item : T,width : CGFloat)->CGFloat{
        ...
        let checkBetween = currentIndex >= 0 && currentIndex < list.count ? (getIndex(item: item) == currentIndex ? previous : next) : 0
    ...
    func getIndex(item : T)->Int{
        ...
        let index = list.firstIndex { currentItemu in
            
            return currentItemu.id == item.id
